      ...
      <div class="col-lg-10 offset-md-1">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <!-- Form start -->
            <form action="{{ route('admin.employee.update', $edit->id) }}" method="POST" enctype="multipart/form-data">
               @csrf
               @method('put')
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="number" value="{{ $edit->sallery }}" name="sallery" class="form-control @error('sallery') is-invalid @enderror">
                  @error('sallery')
                   <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-10">
                  ...
                  @error('photo')
                   <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                  <img id="previewimg" style="height: 80px; width:25%; margin:15px 0;" src="{{ asset('assets/img/employee/'.$edit->photo) }}" />
                </div>
